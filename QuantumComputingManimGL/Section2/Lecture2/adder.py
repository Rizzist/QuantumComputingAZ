...
class FirstScene(Scene):
	def construct(self):
		text = Text("Quantum Half-Adder, Full Adder").scale(0.9)
		self.play(FadeIn(text))
		self.wait(3)

class adder(Scene):
	def construct(self):
		text = Text("Quantum Half-Adder, Full Adder").scale(1.1)
		self.play(FadeIn(text))
		self.wait(5)
		self.play(FadeOut(text))

		title = Text("Quantum Half-Adder").shift(UP*3.5)
		self.play(Write(title))
	
		isgreater = Tex(r"\begin{tabular}{||c c c c||} \hline X & Y & Carry & Sum\\ [0.5ex] \hline\hline 0 & 0 & 0 & 0\\ \hline 0 & 1 & 0 & 1\\ \hline 1 & 0 & 0 & 1\\ \hline 1 & 1 & 1 & 0\\ [1ex]  \hline \end{tabular}")
		self.play(FadeIn(isgreater))
		self.wait(7)
		self.play(FadeOut(isgreater))

		#visualize half adder
		corona= ImageMobject("./halfadder.jpeg").shift(DOWN*1)
		...
		qlabel3 = Tex(r"Carry").shift(UP*base + DOWN*offset*2 + LEFT*5.75 + DOWN*0.5).set_color(GREEN)


		qlabel4 = Tex(r"X").shift(UP*base + RIGHT*5.75).set_color(GREEN)
		qlabel5 = Tex(r"Sum").shift(UP*base + DOWN*offset + RIGHT*5.75).set_color(GREEN)
		qlabel6 = Tex(r"Carry").shift(UP*base + DOWN*offset*2 + RIGHT*5.75 + DOWN*0.5).set_color(GREEN)
		...
		self.play(FadeOut(peres), FadeOut(itsg), FadeOut(itslines))
		...
		#full adder
		title2 = Text("Quantum Full-Adder").shift(UP*3.5)
		self.play(Transform(title, title2))

		isgreater2 = Tex(r"\begin{tabular}{||c c c c c||} \hline X & Y & Carry In & Carry Out & Sum \\ [0.5ex] \hline\hline 0 & 0 & 0 & 0 & 0\\ \hline 0 & 0 & 1 & 0 & 1\\ \hline 0 & 1 & 0 & 0 & 1\\ \hline 0 & 1 & 1 & 1 & 0\\ \hline 1 & 0 & 0 & 0 & 1\\ \hline 1 & 1 & 0 & 1 & 0\\ \hline 1 & 0 & 1 & 1 & 0\\ \hline 1 & 1 & 1 & 1 & 1\\ [1ex]  \hline \end{tabular}")
		...
		number2 = Tex(r"Y = 0").shift(UP*2.5 + RIGHT*1)
		number3 = Tex(r"C_{in} = 0").shift(RIGHT*4)

		number4 = Tex(r"C_{out} = 0").shift(LEFT*4)
		number5 = Tex(r"Sum = 1").shift(DOWN*2.5)
		...
		qlabel1 = Tex(r"X").shift(UP*base + LEFT*5.75).set_color(GREEN)
		qlabel2 = Tex(r"Y").shift(UP*base + DOWN*offset + LEFT*5.75).set_color(GREEN)
		qlabel3 = Tex(r"C_{in}").shift(UP*base + DOWN*offset*2 + LEFT*5.75 + DOWN*0.5).set_color(GREEN)
		...
		qlabel9 = Tex(r"Sum").shift(UP*base + DOWN*offset*2 + RIGHT*5.75 + UP*0.35).set_color(GREEN)
		qlabel10 = Tex(r"C_{out}").shift(UP*base + DOWN*offset*3 + RIGHT*5.75 + UP*0.35).set_color(GREEN)
		...
		#v gate
		vx = -3
		vnot1 = Dot(np.array([vx,base-offset*1,0]), fill_color=BLACK)
		vnot2 = Tex(r"V").scale(1.5).shift(DOWN*offset*3 + RIGHT*vx + UP*base).set_color(BLACK)
		vnot3 = Line(np.array([vx, base-offset*1, 0]), np.array([vx, -offset*3 + base, 0]))
		...
		cnot2 = Tex(r"\otimes").scale(1.5).shift(DOWN*offset*1 + RIGHT*cx + UP*base).set_color(RED)
		cnot3 = Line(np.array([cx, base, 0]), np.array([cx, -offset*1 + base, 0]))
		cnot = Group(cnot3, cnot2, cnot1)
		self.play(FadeIn(cnot))

		#v gate
		vx2 = -1
		vnot12 = Dot(np.array([vx2,base,0]), fill_color=BLACK)
		vnot22 = Tex(r"V").scale(1.5).shift(DOWN*offset*3 + RIGHT*vx2 + UP*base).set_color(BLACK)
		vnot32 = Line(np.array([vx2, base, 0]), np.array([vx2, -offset*3 + base, 0]))
		...
		vnot24 = Tex(r"V^\dag").scale(1.5).shift(DOWN*offset*3 + RIGHT*vx4 + UP*base).set_color(BLACK)
